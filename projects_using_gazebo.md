...
- **gazebo_terrain_generator**: A super easy-to-use tool for generate 3D Gazebo terrain using real-world elevation and satellite images.[{octicon}`globe` link](https://github.com/saiaravind19/gazebo_terrain_generator)
